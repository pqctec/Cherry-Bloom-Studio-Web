...
// App de Cherry Bloom Studio: envuelve el sitio publico ya desplegado en
// Vercel dentro de una app nativa (Android usa webview_flutter, Windows usa
// webview_windows -- webview_flutter no tiene soporte para escritorio
// Windows). No hay logica propia aqui a proposito: todo (catalogo, cotizar,
// contacto) vive en el sitio web, para no duplicar mantenimiento.
...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  Future<void> _initWindows() async {
    ...
    try {
      ...
      // La causa mas comun es que falte instalado el "WebView2 Runtime" de
      // Microsoft (viene incluido en Windows 10/11 actualizados, pero en
      // versiones viejas hay que instalarlo aparte).
      if (!mounted) return;
